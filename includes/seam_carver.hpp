...
public:
  ...
  int GetEnergyMostPixels(int row, int col) const;
  int GetEnergyFor00() const;
  int GetEnergyFor0Width() const;
  int GetEnergyForHeight0() const;
  int GetEnergyForHeightWidth() const;
  int GetEnergyForLeftEdge(int row) const;
  int GetEnergyForRightEdge(int row) const;
  int GetEnergyForUpperEdge(int col) const;
  int GetEnergyForLowerEdge(int col) const;

  int* HorizontalSeamHelper(int** two_d_array) const;
  int HorizontalMinValue(int** two_d_array, int row, int col) const;
  int HorizontalMinValueIndex(int** two_d_array, int min_value, int row, int col) const;

  int* VerticalSeamHelper(int** two_d_array) const;
  int VerticalMinValue(int** two_d_array, int row, int col) const;
  int VerticalMinValueIndex(int** two_d_array, int min_value, int row, int col) const;
